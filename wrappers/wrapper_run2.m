...
loadCheckpoint = false; % '../output/sloped_run4_set1/sloped_run4_time_295.00_yr.mat';  % false | filename

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Start of parameters to edit
runName = 'run2'; % base name for run and file output
...
Qw_threshold = 0.25; % water discharge fraction to cut off channels
