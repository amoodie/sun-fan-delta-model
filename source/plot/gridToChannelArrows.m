function gridToChannelArrows(grid, varargin)
    ...
    % [~] = walkChannelToNodeDrawArrowsLegacy(grid.flowsTo, iStart, jStart, visitedCells);
...
%             ijFlowsTo = flowsTo{i,j};
            ijFlowsTo = grid.nghbrs(logical(grid.flowsToGraph(:, i, j)), i, j);
...
function [visitedCells] = walkChannelToNodeDrawArrowsLegacy(flowsTo, iStart, jStart, visitedCells)
